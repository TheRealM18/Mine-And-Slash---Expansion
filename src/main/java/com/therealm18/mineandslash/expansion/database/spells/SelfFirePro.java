...
import com.therealm18.mineandslash.expansion.database.spells.stats.Speed;
...
public class SelfFirePro extends BaseSpell {
	...
	@Override
	public String GUID() {
		return "spell_self_fireprotection";
	}

	@Override
	public ITextComponent GetDescription(SpellItemData arg0) {
		return CLOC.tooltip("spell_self_fireprotection");
	}
	...
	public Item SpellItem() {
		return com.therealm18.mineandslash.expansion.database.items.spells.SelfFirePro.ITEM;
	}
	...
	public boolean cast(World world, PlayerEntity caster, Hand hand, int ticksInUse, SpellItemData data) {
		try {
			if(!world.isRemote) {
				...
				caster.addPotionEffect(new EffectInstance(Effects.FIRE_RESISTANCE, 1000, 5));
			} else {
