...
public class SelfSpeed extends BaseSpell {
	...
	public Item SpellItem() {
		return com.therealm18.mineandslash.expansion.database.items.spells.SelfSpeed.ITEM;
	}
	...
	public boolean cast(World world, PlayerEntity caster, Hand hand, int ticksInUse, SpellItemData data) {
		try {
			if(!world.isRemote) {
				...
				caster.addPotionEffect(new EffectInstance(Effects.SPEED, 200, 5));
			} else {
