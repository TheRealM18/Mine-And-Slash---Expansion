...
import com.therealm18.mineandslash.expansion.database.spells.stats.JumpBoost;
...
public class SelfJumpBoost extends BaseSpell {
	...
	@Override
	public String GUID() {
		return "spell_self_jump";
	}

	@Override
	public ITextComponent GetDescription(SpellItemData arg0) {
		return CLOC.tooltip("spell_self_jump");
	}
	...
	public Item SpellItem() {
		return com.therealm18.mineandslash.expansion.database.items.spells.SelfJumpBoost.ITEM;
	}
	...
	public boolean cast(World world, PlayerEntity caster, Hand hand, int ticksInUse, SpellItemData data) {
		try {
			if(!world.isRemote) {
				...
				caster.addPotionEffect(new EffectInstance(Effects.JUMP_BOOST, 200, 5));
			} else {
