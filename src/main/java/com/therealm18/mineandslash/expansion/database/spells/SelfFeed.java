...
import com.therealm18.mineandslash.expansion.database.spells.stats.Feed;
...
public class SelfFeed extends BaseSpell {
	...
	public Item SpellItem() {
		return com.therealm18.mineandslash.expansion.database.items.spells.SelfFeed.ITEM;
	}
