...
import com.therealm18.mineandslash.expansion.database.stats.stat_types.NightVision;
...
public class SpellSelfNightVision extends BaseSpell {
	...
	public Item SpellItem() {
		return ItemSelfNightVision.ITEM;
	}
