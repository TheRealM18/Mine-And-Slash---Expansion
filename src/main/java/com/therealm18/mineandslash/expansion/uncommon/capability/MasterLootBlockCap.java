package com.therealm18.mineandslash.expansion.uncommon.capability;
...
public class MasterLootBlockCap {
    ...
    public static class DefaultImpl implements IMasterLootBagData {
        ...
        @Override
        public ItemStackHandler getInventory(MasterChestContainer.ItemType type) {
